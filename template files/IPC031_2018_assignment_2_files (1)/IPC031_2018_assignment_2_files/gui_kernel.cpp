/*****************************************************************************************
	...
	Last Modified:	July 11 2018, by Peter Achten, Radboud University (remove scrollbars)
*****************************************************************************************/
...
//PAstatic int dwScrollUnit = 50;		//	dwScrollUnit defines the amount of stepwise scrolling (horizontally and vertically)
...
//PA: scrollbars have been removed, so this is no longer needed
//PA	SetScrollRange (the_window,SB_HORZ,MINCOORD,MAXCOORD-windowSize.cx,true);
//PA	SetScrollRange (the_window,SB_VERT,MINCOORD,MAXCOORD-windowSize.cy,true);
...
GFONT :: GFONT ()
{
	GFONT ("Times New Roman", 10, Plain);		// PA: chosen fixed font. Can be improved.
}
...
/*PA: removed scrollbars, so default window handler can manage this
		case WM_SIZE:
			{
